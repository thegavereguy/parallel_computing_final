...
const Conditions test_cases[8] = {
    {1.0, 0.01, 1.0, 256, 1000},       {1.0, 0.02, 1.5, 4096, 15000},
    {2.0, 0.03, 2.0, 16384, 30000},    {1.5, 0.04, 2.5, 65536, 50000},
    {1.0, 0.01, 3.0, 262144, 80000},   {1.5, 0.02, 3.5, 1048576, 120000},
    {2.0, 0.03, 4.0, 4194304, 180000}, {2.0, 0.04, 4.5, 16777216, 250000},
};
